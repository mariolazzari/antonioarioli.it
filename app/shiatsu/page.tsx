...
import { Video } from "@/components/Players";
...
function ShiatsuPage() {
  return (
    <>
      ...
      <p className="text-justify max-w-xl mx-auto px-8 md:p-0">
        ...
        pressione esercitata con mani, gomito o ginocchio su alcuni punti, aree
        o canali energetici (meridiani), contatta la vitalità del ricevente
        favorendone il suo fluire naturale. Le pressioni esercitate
      ...
      <h3 className="text-xl text-primary font-semibold text-center my-8">
        Trattamento meridiano di vescica biliare
      </h3>

      <Video src="https://cloud1.cam.tv/CID071F56/feed/CNT98E13C/video.mp4?t=1635712543" />

      <p className="text-justify max-w-xl mx-auto px-8 md:p-0 my-8">
        ...
        biliare. La vescica biliare è la sperimentazione di un nuovo inizio che
        elimina le memorie dolorose, guardando la vita con l’innocenza di un
        bambino. Molto efficace nel trattamento di cefalee, fibromialgia e
        dolori articolari. È il meridiano della rinascita, che possiamo sentire
        dentro di noi e vedere nel mondo.
      </p>
    </>
  );
}
